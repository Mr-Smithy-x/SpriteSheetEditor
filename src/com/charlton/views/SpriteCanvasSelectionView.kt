...
class SpriteCanvasSelectionView : BaseCanvasView {
    ...
    interface SpriteCanvasMouseCallback {
        fun onDoubleClicked(bounds: SpriteBounds)
    }
    ...
    private var selectedSpriteBounds: SpriteBounds? = null
    ...
    private fun drawImage(x: Double, y: Double) {
        ...
        if (c.alpha != 0) {
            ...
            if (lowX != null && highX != null && lowY != null && highY != null) {
                ...
                selectedSpriteBounds = SpriteBounds(lowX.toInt(), lowY.toInt(), width.toInt(), height.toInt())
    ...
    fun getSelectedImage(): SpriteBounds? {
